...
const C1104_Layer = L.geoJson(C1104, {
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(`
            <p style='margin:0; padding:0; color:#4ef54a; background-color: black'; padding:3px; border-radius:3px><strong>Contrat : </strong> ${feature.properties.Contrat}</p>
...
const C1105_Layer = L.geoJson(C1105, {
  ...
  onEachFeature: function (feature, layer) {
    layer.bindPopup(`
            <p style='margin:0; padding:0; color:#f5df4a; background-color: black; padding:3px; border-radius:3px'><strong>Contrat : </strong> ${feature.properties.Contrat}</p>
